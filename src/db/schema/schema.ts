...
export const FormDataTable = pgTable(
  "form_data",
  {
    ...
    player3: varchar("player_3", { length: 255 }).notNull(),
    playerId3: varchar("player_id_3", { length: 100 }).notNull(),

    player4: varchar("player_4", { length: 255 }).notNull(),
    playerId4: varchar("player_id_4", { length: 100 }).notNull(),

    iglMail: varchar("igl_mail", { length: 255 }).notNull(),
    iglAlternateMail: varchar("igl_alternate_mail", { length: 255 }).notNull(),

    iglNumber: varchar("igl_number", { length: 15 }).notNull(),
    iglAlternateNumber: varchar("igl_alternate_number", { length: 15 }).notNull(),
  ...
  (table) => ({
    ...
    iglAltMailIndex: uniqueIndex("form_data_igl_alt_mail_unique").on(table.iglAlternateMail),
    iglNumberIndex: uniqueIndex("form_data_igl_number_unique").on(table.iglNumber),
    iglAltNumberIndex: uniqueIndex("form_data_igl_alt_number_unique").on(table.iglAlternateNumber),
  }),
)
