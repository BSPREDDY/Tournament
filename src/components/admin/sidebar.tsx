...
export function Sidebar() {
  ...
  return (
    <>
      {/* Mobile Header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-card border-b border-border z-40 h-16 flex items-center px-4">
        <button
        ...
        <h1 className="text-lg font-bold text-primary ml-3">Admin Panel</h1>
      </div>
      ...
      >
        ...
        <Button
          ...
          variant="outline"
          className="w-full justify-start gap-3 text-destructive hover:text-destructive hover:bg-destructive/10 bg-transparent text-sm sm:text-base flex-shrink-0"
        >
