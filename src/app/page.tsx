        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
            ...
            <div className="slide-in" style={{ animationDelay: '0.1s' }}>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li>
                  <Link href="/auth/user/signup" className="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">
                    Register
                  </Link>
                </li>
                <li>
                  <Link href="/auth/user/login" className="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">
                    Login
                  </Link>
                </li>
              </ul>
